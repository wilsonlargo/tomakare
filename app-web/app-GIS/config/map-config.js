...
function openfile2(control) {
    ...
    lector.onload = function (e) {
        ...
        function maker_coltrol_layer(name, title) {
            ...
            const btnConfigLayer = document.getElementById("btnConfigLayer" + name)
            btnConfigLayer.onclick = () => {
                config_format("layer_" + name, "bodyCollapse" + name)
            }
        ...
        //let layer_existe = format_layer.filter(ele=>ele=="layer_" + name_layer[0].replace(" ", ""))
        //console.log(layer_existe)
